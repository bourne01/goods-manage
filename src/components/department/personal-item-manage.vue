...
export default {
    ...
    methods:{
        ...
        recipientManage(){
            ...
            this.getGoodsList(/* {
                ...
                } */this.curDate,this.reposId,this.user.userid);
        },
        /**@function 监听点击退库管理事件*/
        returnManage(){
            this.isActive = true;
        ...
        getGoodsList(dt,reposId,userId){
            ...
            //如果用户选择了月份，则自动添上今年年份
            if(params.months)params.year=(new Date()).getFullYear();
    ...
    created(){
        ...
        this.curDate = JSON.parse(QueryParams.curDate);
        this.isActive = QueryParams.isRecepient;
        this.user.userid = QueryParams.opUserId;
        this.getGoodsList(this.curDate,null,QueryParams.opUserId);
    ...
    mounted(){
        ...
        //let tbodyHeight = (1-(182*htmlWidth)/(375*htmlHeight))*100+'vh';  
